...
- complete search request fixture
- satisfy broad search lint gate
- bound broad fulltext searches

### Fixed
- exclude Studio from network search, add post-type map Site Health check
- preserve search relevance scoring

## [0.3.6] - 2026-08-23

### Changed
- cache bounded search candidates

## [0.3.5] - 2026-08-23

### Changed
- bound broad FULLTEXT searches
- execute one canonical search query

## [0.3.4] - 2026-08-23

### Fixed
- prevent unindexed search fallbacks
- preserve search request state

## [0.3.3] - 2026-07-12

### Changed
- rename extrachill_multisite_search to extrachill_network_search (#12)
